...
#ifndef SIMPLE_BCU_CONTROLLER_H
#define SIMPLE_BCU_CONTROLLER_H

/**
 * @file simpleBCUController.h
 ...
 */
class simpleBCUController : public tgObserver<TensegrityModel>
{
public:
...
private:
   ...
   */
  std::vector<tgRod*> p_rigidWithTags;
