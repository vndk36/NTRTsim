...
#ifndef STEPWISE_CONTROLLER_H
#define STEPWISE_CONTROLLER_H
 ...
 */
class StepwiseController : public tgObserver<TensegrityModel>, public tgSubject<StepwiseController>
{
public:
