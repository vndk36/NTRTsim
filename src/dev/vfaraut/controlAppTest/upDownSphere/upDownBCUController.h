...
#ifndef UP_DOWN_BCU_CONTROLLER_H
#define UP_DOWN_BCU_CONTROLLER_H

/**
 * @file upDownBCUController.h
 ...
 */
class upDownBCUController : public tgObserver<TensegrityModel>
{
public:
   ...
   */
  upDownBCUController(std::vector<std::string> tagsToControl);

  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~upDownBCUController() { }
...
#endif // UP_DOWN_BCU_CONTROLLER_H