...
upDownBCUController::upDownBCUController(std::vector<std::string> tagsToControl) :
 ...
 */
void upDownBCUController::initializeActuators(TensegrityModel& subject,
						    std::string tag) {
  //DEBUGGING
 ...
 */
void upDownBCUController::onSetup(TensegrityModel& subject)
{
...
void upDownBCUController::onStep(TensegrityModel& subject, double dt)
{
...
void upDownBCUController::setMassForOneRigid (int rigidIdx, double dt)
{
  int tmpCase = 0;
