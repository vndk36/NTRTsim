...
rotRodBCUController::rotRodBCUController(std::vector<std::string> tagsToControl) :
 ...
 */
void rotRodBCUController::initializeActuators(TensegrityModel& subject,
						    std::string tag) {
  //DEBUGGING
 ...
 */
void rotRodBCUController::onSetup(TensegrityModel& subject)
{
...
void rotRodBCUController::onStep(TensegrityModel& subject, double dt)
{
...
void rotRodBCUController::setMassForOneRigid (int rigidIdx, double dt)
{
  int tmpCase = 0;
