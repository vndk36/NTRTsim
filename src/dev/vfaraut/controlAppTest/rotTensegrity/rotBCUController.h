...
#ifndef ROT_BCU_CONTROLLER_H
#define ROT_BCU_CONTROLLER_H

/**
 * @file rotBCUController.h
 ...
 */
class rotBCUController : public tgObserver<TensegrityModel>
{
public:
   ...
   */
  rotBCUController(std::vector<std::string> tagsToControl);

  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~rotBCUController() { }
